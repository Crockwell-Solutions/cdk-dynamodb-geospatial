 ...
 *
 * This CDK stack sets up the frontend resources for the DynamoDB Geospatial Demo Project.
...
export class FrontendStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendResourcesProps) {
    ...
    const websiteBucket = new Bucket(this, 'DynamoDBGeospatialDemoWebsiteBucket', {
      removalPolicy: RemovalPolicy.DESTROY,
      autoDeleteObjects: true,
    });

    // Create CloudFront distribution
    this.distribution = new Distribution(this, 'DynamoDBGeospatialDemoWebsiteDistribution', {
    ...
    this.exportValue(this.distribution.distributionDomainName, {
      ...
      description: 'The domain name of the CloudFront distribution for the DynamoDB Geospatial Demo',
    });
  }
}
